...
"showLines": 2,
"lessText": "'. esc_html(__('Show less', 'reviews-widgets-for-yelp')) .'",
"moreText": "'. esc_html(__('Show more', 'reviews-widgets-for-yelp')) .'",
});
...
?>
<div class="ti-header-title"><?php echo esc_html(__('My Reviews', 'reviews-widgets-for-yelp')); ?></div>
<div class="ti-box">
<?php if (!$isReviewDownloadInProgress): ?>
<?php if ($reviewDownloadFailed): ?>
<div class="ti-notice ti-notice-error">
<p><?php echo esc_html(__('The manual review download not available yet.', 'reviews-widgets-for-yelp')); ?></p>
</div>
<?php endif; ?>
...
<?php echo esc_html(__('Download new reviews', 'reviews-widgets-for-yelp'));?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Now, you can download your new reviews.', 'reviews-widgets-for-yelp')); ?></span>
</a>
<?php else: ?>
...
/* translators: %d: days */
echo esc_html(sprintf(__('The manual review download will be available again in %d day(s).', 'reviews-widgets-for-yelp'), $days));
?></span>
</a>
<?php endif; ?>
...
<strong><?php echo esc_html(__('UPGRADE to PRO Features', 'reviews-widgets-for-yelp')); ?></strong>
<p><?php
/* translators: %d: platform number */
echo esc_html(sprintf(__('Automatic review update, creating unlimited review widgets, downloading and displaying all reviews, %d review platforms available!', 'reviews-widgets-for-yelp'), 137));
?></p>
<?php echo wp_kses_post($pluginManagerInstance->getProFeatureButton('wp-yelp-pro')); ?>
</div>

<?php if ($isReviewDownloadInProgress === 'error'): ?>
<div class="ti-notice ti-mb-1 ti-notice-error">
<p>
<?php echo esc_html(__('While downloading the reviews, we noticed that your connected page is not found.<br />If it really exists, please contact us to resolve the issue or try connect it again.', 'reviews-widgets-for-yelp')); ?><br />
</p>
</div>
...
<p><?php echo esc_html(__('You had no reviews at the time of last review downloading.', 'reviews-widgets-for-yelp')); ?></p>
</div>
<?php endif; ?>
<?php else: ?>
...
<thead>
<tr>
<th class="ti-text-center"><?php echo esc_html(__('Reviewer', 'reviews-widgets-for-yelp')); ?></th>
<th class="ti-text-center" style="width: 90px;"><?php echo esc_html(__('Rating', 'reviews-widgets-for-yelp')); ?></th>
<th class="ti-text-center"><?php echo esc_html(__('Date', 'reviews-widgets-for-yelp')); ?></th>
<th style="width: 50%"><?php echo esc_html(__('Text', 'reviews-widgets-for-yelp')); ?></th>
</tr>
</thead>
<tbody>
...
<td class="ti-text-center source-<?php echo esc_attr(ucfirst("yelp")); ?>"><?php echo wp_kses_post(trustindex_plugin_write_rating_stars($review->rating)); ?></td>
...
<?php if ($review->reply): ?>
<a href="#" class="ti-btn ti-btn-default ti-btn-sm ti-btn-default-disabled btn-show-ai-reply"><?php echo esc_html(__('Reply', 'reviews-widgets-for-yelp')); ?></a>
<?php else: ?>
<a href="#" class="ti-btn ti-btn-sm btn-show-ai-reply" data-edit-reply-text="<?php echo esc_html(__('Reply', 'reviews-widgets-for-yelp')); ?>"><?php echo esc_html(__('Reply with ChatGPT', 'reviews-widgets-for-yelp')); ?></a>
<?php endif; ?>
<?php endif; ?>
<?php if ($review->text): ?>
<a href="<?php echo esc_attr($review->id); ?>" class="ti-btn ti-btn-sm ti-btn-default btn-show-highlight<?php if (isset($review->highlight) && $review->highlight): ?> has-highlight<?php endif; ?>"><?php echo esc_html(__('Highlight text', 'reviews-widgets-for-yelp')) ;?></a>
<?php endif; ?>
<?php endif; ?>
...
<?php if (!$review->hidden): ?>
<?php echo esc_html(__('Hide review', 'reviews-widgets-for-yelp')); ?>
<?php else: ?>
<?php echo esc_html(__('Show review', 'reviews-widgets-for-yelp')); ?>
<?php endif; ?>
</a>
...
<strong><?php echo esc_html(__('ChatGPT generated reply', 'reviews-widgets-for-yelp')); ?></strong>
<span><?php echo esc_html(__('you can modify before upload', 'reviews-widgets-for-yelp')); ?>
</div>
<textarea id="ti-ai-reply-<?php echo esc_attr($review->id); ?>" rows="1"></textarea>
<?php if (!$review->text): ?>
<div class="ti-alert ti-alert-empty-review d-none"><?php echo esc_html(__("The reply was generated in your widget language because the review's text is empty.", 'reviews-widgets-for-yelp')); ?></div>
<?php endif; ?>
...
echo esc_html(sprintf(__('Upload reply to %s', 'reviews-widgets-for-yelp'), 'Yelp'));
?></a>
<a href="#" class="ti-btn ti-btn-sm ti-btn-no-background btn-hide-ai-reply"><?php echo esc_html(__('Cancel', 'reviews-widgets-for-yelp')); ?></a>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo esc_html(__('Copy the reply', 'reviews-widgets-for-yelp')); ?></strong>
</div>
<div class="ti-alert ti-alert-warning ti-d-none">
<?php echo esc_html(__('We could not connect your account with the review.', 'reviews-widgets-for-yelp')); ?>
<a href="#" class="btn-try-reply-again"><?php echo esc_html(__('Try again', 'reviews-widgets-for-yelp')); ?></a>
</div>
...
<div class="ti-button-dropdown-title">
<strong><?php echo esc_html(__('Highlight text', 'reviews-widgets-for-yelp')); ?></strong>
<span><?php echo esc_html(__('just select the text you want to highlight', 'reviews-widgets-for-yelp')); ?>
</div>
...
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-save-highlight')); ?>" class="ti-btn ti-btn-sm btn-save-highlight"><?php echo esc_html(__('Save', 'reviews-widgets-for-yelp')); ?></a>
<a href="#" class="ti-btn ti-btn-sm ti-btn-no-background btn-hide-highlight"><?php echo esc_html(__('Cancel', 'reviews-widgets-for-yelp')); ?></a>
<?php if ($review->highlight): ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('ti-save-highlight')); ?>" class="ti-btn ti-btn-sm ti-btn-danger ti-pull-right btn-remove-highlight"><?php echo esc_html(__('Remove highlight', 'reviews-widgets-for-yelp')); ?></a>
<?php endif; ?>
</div>
<?php endif; ?>
</td>
