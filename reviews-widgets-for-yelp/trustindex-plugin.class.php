...
return '<a class="ti-btn" href="https://lp.trustindex.io/'.$this->getShortName().'-wp/?a=sys&c='. $campaignId .'" target="_blank">'. __('Create a Free Account for More Features', 'reviews-widgets-for-yelp') .'</a>';
}
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-13.2.7", "do-not-care-Widgets for Yelp Reviews", "do-not-care-Yelp");
...
return $this->frontEndErrorForAdmins(__('Free plugin features are unavailable with AMP plugin.', 'reviews-widgets-for-yelp'));
}
...
if (!$reviews) {
return self::get_alertbox('error', __('You do not have reviews with the current filters. <br />Change your filters if you would like to display reviews on your page!', 'reviews-widgets-for-yelp'));
}
